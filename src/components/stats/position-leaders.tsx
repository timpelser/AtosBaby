...
import { ATTACKER_STATS, DEFENDER_STATS } from "@/lib/dummy-data"
...
export function PositionLeaders() {
  const topAttacker = ATTACKER_STATS[0]
  const topDefender = DEFENDER_STATS[0]

  if (!topAttacker || !topDefender) return null
